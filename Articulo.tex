...
\begin{enumerate}
    ...
    {\footnotesize \[
    \mathbb{P}\big(\text{tiempo de viaje} > 90 \ \text{min} \mid E = \text{bajo}\big, p5_13 = \text{al trabajo}, p5_6 = \text{Casa}) = 0.0131
    \]}
    {\footnotesize \[
    \mathbb{P}\big(\text{tiempo de viaje} > 90 \ \text{min} \mid E = \text{alto}\big, p5_13 = \text{al trabajo}, p5_6 = \text{Casa}) = 0.0170
    \]}
\end{enumerate}
